...
function sendRequest() {
	...
	try {
		...
		jQuery('#contactWrapper').append('<div class="success"><h4>Email enviado correctamente</h4><br><p>Gracias por comunicarte con nosotros <strong>' + decodeURIComponent(name) + '</strong>. Tu email se envió correctamente y nos pondremos en contacto lo antes posible.</p></div>');
	}
}
...
function check_values() {
	...
	if ($j('#contactform #name').val() != undefined)
		if ($j('#contactform #name').val() == '') {
			...
			if (!hasClass)
				$j('#contactform #name').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese su nombre.</label>');
	...
	if ($j('#contactform #email').val() != undefined)
		if (validate_email($j('#contactform #email').val()) == false) {
			...
			if (!hasClass)
				$j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese un email válido.</label>');
	...
	if ($j('#contactform #subject').val() != undefined)
		if ($j('#contactform #subject').val() == '') {
			...
			if (!hasClass)
				$j('#contactform #subject').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese un asunto.</label>');
	...
	if ($j('#contactform #body').val() != undefined)
		if ($j('#contactform #body').val() == '') {
			...
			if (!hasClass)
				$j('#contactform #body').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese un mensaje.</label>');
...
function check_values_booking() {
	...
	if ($j('#contactform_booking #name').val() != undefined)
		if ($j('#contactform_booking #name').val() == '') {
			...
			if (!hasClass)
				$j('#contactform_booking #name').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese su nombre.</label>');
...
function check_values_news() {
	...
	if ($j('#newsletterform #name_news').val() != undefined)
		if ($j('#newsletterform #name_news').val() == '') {
			...
			if (!hasClass)
				$j('#newsletterform #name_news').parent().append('<label for="contactname" generated="true" class="error">Por favor, ingrese su nombre.</label>');
